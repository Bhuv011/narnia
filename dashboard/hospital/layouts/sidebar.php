      ...
      <li class="nav-item">
        ...
        <div class="multi-level collapse" role="list"
          ...
          <ul class="flex-column nav">
            <li class="nav-item">
              <a class="nav-link" href="patients.php?status=accepted">
                <span class="sidebar-text">Approved</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="patients.php?status=rejected">
                <span class="sidebar-text">Rejected</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="patients.php?status=failed">
                <span class="sidebar-text">Failed</span>
              </a>
            </li>
          </ul>
        </div>
