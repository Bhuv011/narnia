...
<body>
                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                            <div class="text-center text-md-center mb-4 mt-md-0">
                                <h1 class="mb-0 h3">Ambulance | Sign In</h1>
                            </div>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" name="email" class="form-control"
                                            ...
                                            value="<?php echo isset($_POST['submit']) && isset($_POST['email']) ? $_POST['email'] : null ?>" />
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="password" name="password" placeholder="Password"
                                                ...
                                                value="<?php echo isset($_POST['submit']) && isset($_POST['password']) ? $_POST['password'] : null ?>" />
                                        </div>
                                    </div>
                                </div>
                                <div class="d-grid">
    ...
    <script src="dashboard/assets/js/volt.js"></script>
</body>
